...
//         <div className="flex flex-col basis-1/2 gap-1 justify-center mx-auto border-2 border-red-500 border-solid">
...
export default function Team() {
  return (
    <div className="flex flex-col gap-3 lg:gap-5 font-poppins text-center">
      ...
      <div className="flex flex-col lg:flex-row flex-wrap gap-8 lg:gap-10 py-6 my-0 lg:mx-24">
